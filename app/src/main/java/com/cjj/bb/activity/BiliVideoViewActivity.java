...
//        }
	...
	public void onConfigurationChanged(Configuration newConfig) {
		if (isInitialized()) {
			...
			Log.d("yzr_bili","------onConfigurationChanged------->");
		}
		Log.d("yzr_bili","---------111---->");
